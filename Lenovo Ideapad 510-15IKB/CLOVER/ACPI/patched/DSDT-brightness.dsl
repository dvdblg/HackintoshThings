 ...
 *
 * Disassembly of DSDT.aml, Sun Dec  3 13:12:03 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001C96B (117099)
 *     Revision         0x02
 *     Checksum         0x4C
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
     ...
     * disassembly, but only 34 were resolved (4 unresolved). Additional
    ...
    External (_SB_.PCI0.SAT0.NVM1.IR3E, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.SAT0.NVM1.RAID, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.SAT0.NVM2.IR3E, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.SAT0.NVM2.RAID, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.SAT0.NVM3.IR3E, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.SAT0.NVM3.RAID, MethodObj)    // 0 Arguments (from opcode)
    ...
    External (IR3E, UnknownObj)    // (from opcode)
    ...
    External (RAID, UnknownObj)    // (from opcode)
    ...
    External (VLPM, UnknownObj)    // (from opcode)

    Name (SS1, Zero)
    Name (SS2, Zero)
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x7CE4C018, 0x06BB)
    ...
    OperationRegion (OGNS, SystemMemory, 0x7CE4CFD8, 0x0C)
    ...
    Scope (_SB)
    {
        ...
        Method (CGLS, 0, Serialized)
        {
            ...
            {
                Store (Add (ShiftRight (GINF (Local0, One), 0x05), One), Local3)
                Store (Zero, Local2)
                While (LLess (Local2, Local3))
                {
                    ...
                    ElseIf (LEqual (Local4, 0x08))
                    {
                        Store (G2L8, Local5)
                    }
                    ElseIf (LEqual (Local4, 0x07))
                    {
                        Store (G2L7, Local5)
                    }
                    ElseIf (LEqual (Local4, 0x06))
                    {
                        Store (G2L6, Local5)
                    }
                    ElseIf (LEqual (Local4, 0x05))
                    {
                        Store (G2L5, Local5)
                    }
                    ...
                    ElseIf (LEqual (Local4, 0x02))
                    {
                        Store (G2L2, Local5)
                    }
                    ElseIf (LEqual (Local4, One))
                    {
                        Store (G2L1, Local5)
                    }
                    ElseIf (LEqual (Local4, Zero))
                    {
                        Store (G2L0, Local5)
                    }
                    Else
        ...
        Device (XHC)
        {
            ...
            Device (RHUB)
            {
                ...
                Device (HS03)
                {
                    ...
                    {
                        If (LEqual (GGIV (0x02030008), Zero))
                        {
                            Return (GUPC)
                        }
                        Else
                ...
                Device (SS03)
                {
                    ...
                    Name (_PLD, Package (0x01)  // _PLD: Physical Location of Device
                    {
                        ...
                        {
                            /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                            /* 0008 */  0x28, 0x02, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
        ...
        Device (SAT0)
        {
            ...
            Device (NVM1)
            {
                ...
                Method (_PS3, 0, Serialized)  // _PS3: Power State 3
                {
                    If (CondRefOf (IR3E))
                    {
                        ADBG (Concatenate ("_PS3s: ", ToHexString (VLPM)))
                        If (LEqual (IR3E (), One))
                        {
                            If (LEqual (RAID (), Zero))
                            {
                        ...
                        ADBG (Concatenate ("_PS3e: ", ToHexString (VLPM)))
                    }
                }
                ...
                Method (_PS0, 0, Serialized)  // _PS0: Power State 0
                {
                    If (CondRefOf (IR3E))
                    {
                        ADBG (Concatenate ("_PS0s: ", ToHexString (VLPM)))
                        If (LEqual (IR3E (), One))
                        {
                            If (LEqual (RAID (), Zero))
                            {
                        ...
                        ADBG (Concatenate ("_PS0e: ", ToHexString (VLPM)))
                    }
                }
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (TPL1)
        {
            ...
            CreateWordField (SBFB, \_SB.PCI0.I2C1.TPL1._Y23._ADR, BADR)  // _ADR: Address
            CreateDWordField (SBFB, \_SB.PCI0.I2C1.TPL1._Y23._SPE, SPED)  // _SPE: Speed
            CreateDWordField (SBFI, \_SB.PCI0.I2C1.TPL1._Y24._INT, INT2)  // _INT: Interrupts
            CreateWordField (SBFG, 0x17, INT1)
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                If (LLess (OSYS, 0x07DC))
    ...
    Scope (_SB.PCI0.SPI1)
    {
        Device (FPNT)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                {
                    GpioInt (Level, ActiveLow, ExclusiveAndWake, PullDefault, 0x0000,
                        "\\_SB.PCI0.GPI0", 0x00, ResourceConsumer, _Y27,
                        )
                        {   // Pin list
                            0x0000
                        }
                ...
                CreateDWordField (BBUF, \_SB.PCI0.SPI1.FPNT._CRS._Y25._SPE, SPEX)  // _SPE: Speed
                CreateByteField (BBUF, \_SB.PCI0.SPI1.FPNT._CRS._Y25._PHA, PHAX)  // _PHA: Clock Phase
                CreateWordField (BBUF, 0x3B, SPIN)
                CreateWordField (GBUF, 0x17, GPIN)
                CreateDWordField (IBUF, \_SB.PCI0.SPI1.FPNT._CRS._Y26._INT, IPIN)  // _INT: Interrupts
                CreateBitField (IBUF, \_SB.PCI0.SPI1.FPNT._CRS._Y26._LL, ILVL)  // _LL_: Low Level
                CreateBitField (IBUF, \_SB.PCI0.SPI1.FPNT._CRS._Y26._HE, ITRG)  // _HE_: High-Edge
                CreateField (GBUF, \_SB.PCI0.SPI1.FPNT._CRS._Y27._POL, 0x02, GLVL)  // _POL: Polarity
                CreateBitField (GBUF, \_SB.PCI0.SPI1.FPNT._CRS._Y27._MOD, GTRG)  // _MOD: Mode
                CreateBitField (BBUF, \_SB.PCI0.SPI1.FPNT._CRS._Y25._DPL, SCSP)  // _DPL: Device Selection Polarity
        ...
        Device (BTH0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Name (SBFI, ResourceTemplate ()
                {
                    ...
                    Interrupt (ResourceConsumer, Edge, ActiveLow, ExclusiveAndWake, ,, _Y28)
                    {
                        0x00000000,
                    }
                })
                CreateDWordField (SBFI, \_SB.PCI0.UA00.BTH0._CRS._Y28._INT, INT4)  // _INT: Interrupts
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC0)
        {
                ...
                Method (_BST, 0, Serialized)  // _BST: Battery Status
                {
                    ...
                    If (LEqual (ECAV, One))
                    {
                        If (LEqual (Acquire (LFCM, 0xA000), Zero))
                        {
                            ...
                            Sleep (0x10)
                            Store (LRAM (0x04, 0xD2), OBAC)
                            Store (LRAM (0x04, 0xD3), Local3)
                            Or (ShiftLeft (Local3, 0x08), OBAC, OBAC)
                            If (And (OBST, One))
                            {
                            ...
                            Sleep (0x10)
                            Store (LRAM (0x04, 0xC2), OBRC)
                            Store (LRAM (0x04, 0xC3), Local3)
                            Or (ShiftLeft (Local3, 0x08), OBRC, OBRC)
                            Sleep (0x10)
                            Store (LRAM (0x04, 0xC6), OBPV)
                            Store (LRAM (0x04, 0xC7), Local3)
                            Or (ShiftLeft (Local3, 0x08), OBPV, OBPV)
            ...
            Scope (\)
            {
                OperationRegion (LFCN, SystemMemory, 0x7C78DE58, 0xE8)
            ...
            Method (GCBL, 0, Serialized)
            {
                ...
                If (LEqual (Acquire (LFCM, 0xA000), Zero))
                {
                    ...
                    While (One)
                    {
                        ...
                        ElseIf (LEqual (_T_0, 0x2C))
                        {
                            Store (0x07, Local0)
                            Break
                        }
                        ElseIf (LEqual (_T_0, 0x3D))
                        {
                            Store (0x08, Local0)
                            Break
                        }
        ...
        Scope (\_SB)
        {
            ...
            Device (WMI4)
            {
                ...
                Method (BATD, 2, NotSerialized)
                {
                    ...
                    Store (^^PCI0.LPCB.EC0.RECB (0x14, 0x40), BUFR)
    ...
    OperationRegion (MDBG, SystemMemory, 0x7CE39018, 0x1004)
